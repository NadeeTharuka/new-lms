...
const MobileNav = ({ closeNav, showNav }: Props) => {
  ...
  return (
    <div>
      ...
      {/* Sidebar */}
      <div
        className={`text-white fixed justify-center flex flex-col h-full transition-all duration-500 delay-300 w-[80%] sm:w-[60%] bg-indigo-900 space-y-6 z-[100006] ${navOpen}`}
      >
        {/* Nav Links */}
        {navLinks.map((link) => (
